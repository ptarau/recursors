...
st.title("Streamlit-based [DeepLLM](https://github.com/ptarau/recursors) Client 1.0.1")
...
with st.sidebar:
    ...
    recursor = st.select_slider(
        "LLM Agent",
        options=("SymPlanner", "Advisor", "Recursor", "Rater"),
        value="Recursor",
    )
    ...
    initiator = st.text_area(
        "Text of topic to explore (or Natlog program for verification or falsification task):",
